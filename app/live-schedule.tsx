...
function Editor({
  ...
  return (
    <form onSubmit={onSave}>
      ...
      {!fillingHole&&!extensionMode&&<input name="regularEndsAt" type="hidden" value={regularEndsAt}/>} 
