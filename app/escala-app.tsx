...
export function EscalaApp(){
 ...
 return <main className={compact?"app compact":"app"}>
  ...
  <nav className="tabs"><b>Escala</b><span>Movimentações</span><span>Banco de horas</span><span>Horas extras</span><span>Folgas mensais</span><span>Cadastros</span></nav>
